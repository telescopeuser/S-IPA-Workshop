...
FLAGS = flags.FLAGS
flags.DEFINE_string("mini-game", "CollectMineralShards", "Name of the minigame")
...
def training_game():
    env = Environment(map_name="CollectMineralShards", visualize=True, game_steps_per_episode=150,
