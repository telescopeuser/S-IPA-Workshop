...
mini_games = [
    ...
    "MoveToBeacon",  # 120s
    "HallucinIce", # 30s ## <--- GU Zhan (Sam) 2019 07 01
    "ForceField", # 180s ## <--- GU Zhan (Sam) 2019 07 01
    "SentryDefense", # 180s ## <--- GU Zhan (Sam) 2019 07 01
    "FlowerFields", # 180s ## <--- GU Zhan (Sam) 2019 07 01
    "bluemoon", # 180s ## <--- GU Zhan (Sam) 2019 07 01
    "redwaves", # 60s ## <--- GU Zhan (Sam) 2019 07 01
    "TheRightPath", # 180s ## <--- GU Zhan (Sam) 2019 07 01
]
