...
// =====================================
casper.then(function() {{techo('dclick /home/iss-user/iss-vm-program/is-intelligent-process-automation/S-IPA-Workshop/demo/visual_desktop_app_automation/KIE-Loan-Applicaiton-OCR/pdf_IC.png'); var fs = require('fs');
if (!sikuli_step('dclick /home/iss-user/iss-vm-program/is-intelligent-process-automation/S-IPA-Workshop/demo/visual_desktop_app_automation/KIE-Loan-Applicaiton-OCR/pdf_IC.png')) if (!fs.exists('/home/iss-user/iss-vm-program/is-intelligent-process-automation/S-IPA-Workshop/demo/visual_desktop_app_automation/KIE-Loan-Applicaiton-OCR/pdf_IC.png'))
this.echo('ERROR - cannot find image file /home/iss-user/iss-vm-program/is-intelligent-process-automation/S-IPA-Workshop/demo/visual_desktop_app_automation/KIE-Loan-Applicaiton-OCR/pdf_IC.png').exit(); else
this.echo('ERROR - cannot find /home/iss-user/iss-vm-program/is-intelligent-process-automation/S-IPA-Workshop/demo/visual_desktop_app_automation/KIE-Loan-Applicaiton-OCR/pdf_IC.png on screen').exit(); this.wait(0);}});
...
// Execute OCR
// =====================================
casper.then(function() {{techo('read /home/iss-user/iss-vm-program/is-intelligent-process-automation/S-IPA-Workshop/demo/visual_desktop_app_automation/KIE-Loan-Applicaiton-OCR/page.png to pdf_IC_ocr_text'); var fs = require('fs');
if (!sikuli_step('read /home/iss-user/iss-vm-program/is-intelligent-process-automation/S-IPA-Workshop/demo/visual_desktop_app_automation/KIE-Loan-Applicaiton-OCR/page.png to pdf_IC_ocr_text')) if (!fs.exists('/home/iss-user/iss-vm-program/is-intelligent-process-automation/S-IPA-Workshop/demo/visual_desktop_app_automation/KIE-Loan-Applicaiton-OCR/page.png'))
...
casper.then(function() {{techo('write pdf_IC_ocr_text to pdf_IC_ocr_text.txt');
append_text('/home/iss-user/iss-vm-program/is-intelligent-process-automation/S-IPA-Workshop/demo/visual_desktop_app_automation/KIE-Loan-Applicaiton-OCR/pdf_IC_ocr_text.txt',pdf_IC_ocr_text);}});
